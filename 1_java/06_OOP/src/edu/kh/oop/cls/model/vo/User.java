...
public class User {
	...
	public User(String userId,String userPw) {
				//매개변수
		System.out.println("매개변수 생성자를 이용해서 User객체 생성");
...
//		this.userId = userId; // 현재 객체가 가지고 있는 필드 userId에
							  // 매게변수 userId값을 대입
//		this.userPw = userPw; // 현재 객체가 가지고 있는 필드 userPw에
		  					  // 매게변수 userPw값을 대입
		...
		this.userName = userName; // 현재 객체가 가지고 있는 필드 userName에
								  // 매게변수 userName값을 대입
		this.userAge = userAge; // 현재 객체가 가지고 있는 필드 userAge에
		  						// 매게변수 userAge값을 대입
		this.userGender = userGender; // 현재 객체가 가지고 있는 필드 userGender에
		  							  // 매게변수 userGender값을 대입
...
//	public User() {} // 기본 생성자 이미 작성되어 있어서 중복
	...
	public User(int userAge,String userId) {} //매개변수의 개수는 같지만 타입이 다름 ->오버로딩 성립
	
	public User(String userId,int userAge) {} //매개변수의 개수,타입은 같지만 순서가 다름 -> 오버로딩 성립
