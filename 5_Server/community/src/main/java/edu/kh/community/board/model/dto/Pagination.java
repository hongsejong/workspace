...
public class Pagination {
	...
	private int listCount;	 //전체 개시글 수
	...
	private int prevPage;  // 목록 하단 노출된 번호의 이전 목록 끝번호
	private int nextPage;  // 목록 하단에 노출된 번호의 다음 목록 시작번호
	...
	private void calculatePagination() {
		//전체 게시글의 수 : 500 | 보여지는 게시글의 수 : 10개
		//-> 마지막 페이지 번호는 ?  500/10 = 50
		
		//전체 게시글의 수 : 501 | 보여지는 게시글의 수 : 10개
		...
		//현재 페이지 41~50인 경우 (maxPage가 50일때)
		// < :  40페이지
		// > :  50페이지 
