...
(function(){
    ...
    if(goToListBtn !=null){
        goToListBtn.addEventListener("click",()=>{
            ...
            const pathname=location.pathname; //주소 상에서 요청 경로 반환
...
(()=>{
    ...
    if(deleteBtn != null){
        ...
        deleteBtn.addEventListener("click", ()=>{
            ...
            // 현재 : /community/board/detail?no=3756&cp=1&type=3
    
            //목표 : /community/board/delete?no=3756&type=3
            ...
            const no = '?no='+ params.get("no"); // ?no=3756
            const type = '&type='+ params.get("type"); // &type=3
