...
if(inputImage !=null){ //inputImage요소가 화면에 존재 할 때

    // input type='file' 요소는 파일이 선택 될 때 change 이벤트 발생함
    inputImage.addEventListener("change",function(){
        ...
        if(this.files[0] != undefined){ //파일이 선택 되었을 때
            ...
            //자바스크립트의 FileReader
            //- 웹애플리케이션이 비동기적으로 데이터를 읽기 위하여 사용하는 객체
            ...
            reader.onload = function(e){ //고전 이벤트 모델
                ...
                //새로운 이미지가 선택 되었기 떄문에 1->0(안눌러짐 상태)으로 변경
...
document.getElementById("delete-btn").addEventListener("click", ()=>{
    ...
    const del = document.getElementById("delete"); // hidden타입
