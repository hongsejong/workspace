...
$("#input1").on("input", function(){
    ...
    if(regExp.test($("#input1").val())){
        //$("input1").val() : 아이디가 input1 인 요소에 작성된 값(value)를 얻어옴
...
$(()=>{
    ...
    $(".area ul .qqq").css("backgroundColor","yellowGreen")
...
$("#btn1").on("click",function(){
    ...
    let str =''; //체크된 요소의 value값 누적해서 저장할 변수
