...
--SELECT 는 DQL이라고도 하고 DML이라고도 한다
...
CREATE TABLE MEMBER(
	...
	MEMBER_NAME VARCHAR2(30), -- 한글 3BYTE *10 글자 == 30BYTE
...
-->가입을 미작성 시 ->DEFAULT 값이 반영됨

INSERT INTO MEMBER (MEMBER_ID,MEMBER_PWD,MEMBER_NAME,MEMBER_SSN) 
VALUES ('MEM03','PASS03','멤버삼','941212-1234567');
...
INSERT INTO MEMBER2 VALUES('김철수',001216-1234567);
INSERT INTO MEMBER2 VALUES('이영희',0012161234567);
INSERT INTO MEMBER2 VALUES('이나라',9012161234567);
...
--ORA-01400: NULL을 ("KH_HSJ"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_USED_UK(
	...
	--테이블 레벨 제약조건 설정 부분
	--UNIQUE(USER_ID) -- 테이블 레벨 제약조건 설정(재약조건명 미지정)
...
--ORA-00001: 무결성 제약 조건(KH_HSJ.USER_ID_U)에 위배됩니다
...
--UNIQUE 복합키
--두 개 이상의 컬럼을 묶어서 하나의 UNIQUE 제약 조건으로 설정
...
--ORA-00001: 무결성 제약 조건(KH_HSJ.USER_ID_NAME_U)에 위배됩니다
--여러 컬럼을 묶어서  UNIQUE 제약 조건으로 설정한 경우
...
-- ORA-00001: 무결성 제약 조건(KH_HSJ.USER_NO_PK)에 위배됩니다 == UNIQUE 오류와 같음
--> 기본키 중복으로 오류

INSERT INTO USER_USED_PK
VALUES(NULL,'user02','pass02','유저이','F','010-1234-5678','user01@kh.or.kr');
--ORA-01400: NULL을 ("KH_HSJ"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
-- == NOT NULL 오류와 같음
-->기본키가 NULL이므로 오류
...
--ORA-00001: 무결성 제약 조건(KH_HSJ.USERNO_USERID_PK)에 위배됩니다
--회원 번호와 아이디 둘다 중복일 때만 제약조건 위배 에러 발생

INSERT INTO USER_USED_PK2
VALUES(NULL,'user03','pass02','유저이','M','010-1234-5678','user01@kh.or.kr');
--ORA-01400: NULL을 ("KH_HSJ"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
--컬럼명 : GRADE_NAME 한글 최대 10글자 널허용X
...
CREATE TABLE USER_USED_FK(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER, --CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE(GRADE_CODE)--컬럼 레벨 FK작성
	
	CONSTRAINT GRADE_CODE_FK FOREIGN KEY(GRADE_CODE) REFERENCES USER_GRADE
													-->참조 테이블 컬럼명 생략 시 자동으로 PK참조
);
...
--ORA-02291: 무결성 제약조건(KH_HSJ.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
-->참조 무결성 위배
...
WHERE GRADE_CODE=30;
--ORA-02292: 무결성 제약조건(KH_HSJ.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
--ON DELETE SET NULL 옵션이 사용된 테이블 생성
...
SELECT *FROM USER_GRADE2; -- 부모 테이블 삭제 확인(10없음)
...
SELECT *FROM USER_GRADE3; -- 부모 테이블 삭제 확인(30없음)
...
--ORA-02290: 체크 제약조건(KH_HSJ.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST(
	...
	AGE VARCHAR2(5) CONSTRAINT CH_AGE CHECK (AGE >=20)
);
...
VALUES(1,'user01','pass01','881212-1234567','남','010-1234-5678','서울시','N',20);

INSERT INTO USER_TEST
VALUES(2,'user02','pass02','881213-1234567','여','010-1234-5678','서울시','N',20);
INSERT INTO USER_TEST
VALUES(3,'user03','pass03','940828-1234567','남','010-5678-5678','서울시','Y',40);
INSERT INTO USER_TEST
VALUES(4,'user04','pass04','997788-1234567','여','010-9876-5678','서울시','Y',40);
INSERT INTO USER_TEST
VALUES(5,'user05','pass05','776644-1234567','남','010-3545-5678','서울시','N',50);
...
AS SELECT*FROM EMPLOYEE 
WHERE 1 = 2000; -- 무조건 FALSE 되는 구문 만들어서 테이블만 복사되게끔
...
--NOT NULL 제약조건만 복사된 EMPLOYY_COPY 테이블에
