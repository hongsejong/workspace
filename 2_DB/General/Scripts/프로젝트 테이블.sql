...
COMMENT ON COLUMN "COMMENT"."FBOARD_NO" IS '게시글번호(시퀀스)';
...
COMMENT ON COLUMN "BOARD_TYPE"."BOARD_NO" IS '게시판 번호(시퀀스)';
...
COMMENT ON COLUMN "PROOF_BOARD"."CHALLENGE_NO" IS '게시글번호(시퀀스)';

COMMENT ON COLUMN "PROOF_BOARD"."MEMBER_NO2" IS '회원번호(시퀀스)';
...
COMMENT ON COLUMN "CHALLENGE_MEMBER"."REPORT_ID" IS '신고 고유ID(시퀀스)';
...
ALTER TABLE "PROOF_BOARD" ADD CONSTRAINT "FK_CHALLENGE_BOARD_TO_PROOF_BOARD_1" FOREIGN KEY (
	"CHALLENGE_NO"
)
...
ALTER TABLE "PROOF_BOARD" ADD CONSTRAINT "FK_USER_TO_PROOF_BOARD_1" FOREIGN KEY (
	"MEMBER_NO2"
)
REFERENCES "USER" (
	"MEMBER_NO"
