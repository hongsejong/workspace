...
public class Employee {
	...
	public String toString() {
	      return String.format("%d / %s / %s / %s / %s / %s / %s / %s / %d / %f / %d / %s / %s / %s", 
	            empId, empName, empNo, email, phone, deptCode, jobCode, salLevel, salary, bonus, managerId, hireDate, entDate, entYn);
