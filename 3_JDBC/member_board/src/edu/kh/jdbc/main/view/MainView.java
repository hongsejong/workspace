	...
	public void displayMenu() {
		...
		do {
			try {
				...
				if(loginMember==null) { //로그인이 되어있지 않은경우
					...
					switch(menuNum) {
					case 1 : loginMember =memberView.login_1(); break; 
					...
					case 2: memberView.updateMyinfo_1(loginMember); break;
...
//						if(result !=0) loginMember=null; // 로그아웃(int 반환하는경우)
						break;
